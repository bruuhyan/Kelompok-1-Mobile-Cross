-- Complete fix for profiles recursion - defensive policies
...
-- Admin/supervisor policy - only applies if user has a profile
...
-- Admin update policy - only applies if user has a profile
